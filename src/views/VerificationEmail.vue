    ...
    <div class="min-h-100vh padding-haut z-index-10" :class="{ 'bg-clair': !isModeSombre, 'bg-sombre': isModeSombre }" >
        <div class="container pt-5">
            ...
            <form action="" class="mx-auto col-11 col-md-5">
                <input type="number" name="code" id="code-0" class="cacher mx-auto d-block">
                <div class="conteneur-code mx-auto">
                    <input type="number" maxlength="1" name="code-1" id="code-1" class="input-code" placeholder="_" readonly>
                    <input type="number" maxlength="1" name="code-2" id="code-2" class="input-code" placeholder="_" readonly>
                    <input type="number" maxlength="1" name="code-3" id="code-3" class="input-code" placeholder="_" readonly>
                    <input type="number" maxlength="1" name="code-4" id="code-4" class="input-code" placeholder="_" readonly>
                </div>
                <div class="text-14 mx-auto text-center my-4 couleurs-herite cursor-pointer" @click="renvoyerCode" >Renvoyer code</div>
                <router-link to="/" class="form-bouton" :class="{ 'bouton-sombre': !isModeSombre, 'bouton-clair': isModeSombre }">Vérifier</router-link>
            </form>
        </div>
    </div>
</template>
